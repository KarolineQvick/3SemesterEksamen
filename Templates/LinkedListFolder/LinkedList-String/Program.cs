...
class Node
{
    public string data; // Datafeltet for noden
...
class Program
{
    static void Main()
    {
        ...
        myList.AddFront("World");
        myList.AddFront("!");

        // Tilføj elementer bagerst i listen
        myList.AddBack("OpenAI");
        myList.AddBack("ChatGPT");
        ...
        Console.WriteLine("Indeholder listen 'Hello'? " + myList.Contains("Hello"));
        Console.WriteLine("Indeholder listen 'OpenAI'? " + myList.Contains("OpenAI"));

        // Tilføj et element på et bestemt indeks
        myList.AddAtIndex(2, "AI");
